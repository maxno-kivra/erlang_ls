%% =============================================================================
%% An erlang_ls fork of Erlang/OTP's epp_dodger
%% =============================================================================
%% The main reasons for the fork:
%%   * The dodger only works on file, whilst we wanted to operate on binaries
%%   * The dodger loses location information for attributes (e.g. spec)
%%   * The Dialyzer specs for some functions were incorrect
%% =============================================================================
...
-spec parse(file:io_device(), erl_anno:location()) ->
               {'ok', erl_syntax:forms()}.
...
%% behaviour is the same as for {@link parse_file/2}. `StartLoc' is the
%% initial location.
%%
%% @see parse/2
%% @see parse_file/2
...
%%       Forms = [erl_syntax:syntaxTree()]
%%
%% @equiv quick_parse(IODevice, StartLoc, [])
%% @see quick_parse/1
...
%%       LineNo = integer()
%%
%% @equiv parse_form(IODevice, StartLoc, [])
%%
%% @see quick_parse_form/2
